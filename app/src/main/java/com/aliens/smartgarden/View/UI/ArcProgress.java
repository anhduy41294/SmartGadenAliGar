package com.aliens.smartgarden.View.UI;
...
import com.aliens.smartgarden.View.Utils.Utils;
...
public class ArcProgress extends View {
    ...
    private final int default_finished_color = Color.parseColor("#4CAF50");
    private final int default_unfinished_color = Color.parseColor("#FF5252");
